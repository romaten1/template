...
?>
<h1><?= Html::encode( $this->title ) ?> <?= Html::a( Yii::t( 'user', 'Create a user account' ), [ 'create' ],
        [ 'class' => 'btn btn-success' ] ) ?></h1>
...
<?php echo GridView::widget( [
    ...
    'columns'      => [
        ...
        [
            ...
            'value'     => function ( $model, $key, $index, $widget ) {
                return $model->registration_ip == null ? '<span class="not-set">' . Yii::t( 'user',
                        '(not set)' ) . '</span>' : long2ip( $model->registration_ip );
            },
            'format'    => 'html',
        ],
        [
