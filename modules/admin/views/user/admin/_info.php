...
<?php $this->beginContent('@dektrium/user/views/admin/update.php', ['user' => $user]) ?>
    ...
    <table class="table">
        <tr>
            ...
            <td><?= date( 'H:i d.m.Y', $model->created_at ) ?></td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-success"><?= Yii::t('user', 'Confirmed at ') . date( 'H:i d.m.Y', $model->created_at ) ?></td>
            <?php else: ?>
        ...
        <tr>
            ...
            <td class="text-danger"><?= Yii::t('user', 'Blocked at ') . date( 'H:i d.m.Y', $model->blocked_at ) ?></td>
            <?php else: ?>
